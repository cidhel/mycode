...
{ content = "Tequilla, Heineken (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
{ content = "Pas ltemps de niaiser (created via our dynamic block)", file = "/terraform/test4.txt", executable = true }
]
